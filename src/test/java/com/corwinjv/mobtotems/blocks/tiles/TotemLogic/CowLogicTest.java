...
public class CowLogicTest {
    ...
    // TODO Figure out what's needed to implement this test
    // Can't access Block static items until after Minecraft has been initialized. Attempted to do that in setup but test config is missing lwjgl naitives?
    // maybe dagger test injection could help?
//    @Test
